                    ...
                    <div className="p-6 relative z-10 flex flex-col h-full">
                      ...
                      <div className="flex-grow">
                        <div className="flex items-center justify-between mb-6">
                          <div className="px-2 md:px-2  rounded-xl bg-gradient-to-r from-secondary/20 to-primary/20 border border-primary/20 shadow-sm">
                            <span className="text-primary font-extralight md:text-sm md:font-semibold tracking-wide uppercase">
                          ...
                          <div className="flex items-center gap-1">
                            {[...Array(5)].map((_, i) => (
                              <Star
                                key={i}
                                className={` md:w-7 md:h-7  transition-colors duration-200 ${i < program.rating
                        ...
                        <div className="flex items-center gap-5 mb-6">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 md:gap-2">
                              <div className="flex items-center gap-1 md:gap-2 px-0.5 py-2 md:px-1  md:py-1.5 rounded-lg bg-muted/50 backdrop-blur-sm border border-border/50">
                                <Users className="w-4 h-4 text-primary" />
                                <span className="text-sm font-medium text-foreground">{program.age} years</span>
                              </div>
                              <div className="flex items-center gap-1 md:gap-2 px-0.5 py-2 md:px-3 md:py-1.5 rounded-lg bg-muted/50 backdrop-blur-sm border border-border/50">
